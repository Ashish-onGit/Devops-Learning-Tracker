    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        {siblingTopics.length > 0 && (
          <div className="flex items-center gap-2 overflow-x-auto py-2 no-scrollbar border-b border-slate-200 dark:border-[#202020]">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold whitespace-nowrap transition border ${
                    isCurrent
                      ? "bg-slate-100 dark:bg-[#1A1A1A] border-blue-500 text-blue-600 dark:text-blue-400"
                      : "bg-white dark:bg-[#0A0A0A] border-slate-200 dark:border-[#202020] text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-[#151515] hover:text-slate-700 dark:hover:text-slate-200"
                  }`}
                >
        ...
        {siblingTopics.length > 0 && (
          <div className="lg:hidden w-full">
            <button
              ...
              className="w-full flex items-center justify-between p-3 rounded-lg border border-slate-200 dark:border-[#202020] bg-white dark:bg-[#0A0A0A] text-xs font-bold text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-[#151515]"
            >
              <div className="flex items-center gap-2">
            ...
            {mobileDrawerOpen && (
              <div className="mt-2 p-4 rounded-lg border border-slate-200 dark:border-[#202020] bg-white dark:bg-[#050505] space-y-3">
                <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{currentCategory}</h4>
                <div className="h-1.5 w-full bg-slate-100 dark:bg-[#202020] rounded-full overflow-hidden">
                  <div
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center justify-between p-2 rounded-lg text-xs font-semibold transition ${
                          isCurrent
                            ? "bg-slate-100 dark:bg-[#1A1A1A] text-blue-600 dark:text-blue-400"
                            : isLocked
                            ? "opacity-40 cursor-not-allowed text-slate-400 dark:text-slate-500"
                            : "text-slate-650 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-[#151515] hover:text-slate-800 dark:hover:text-slate-200"
                        }`}
                      >
                        ...
                        {isLocked && <Lock className="w-3.5 h-3.5 text-slate-400 dark:text-slate-650" />}
                      </Link>
                    );
                  })}
                </div>
        ...
        {isCompleted && nextTopic && (
          <div className="p-6 rounded-xl border border-emerald-500/20 dark:border-emerald-500/30 bg-emerald-50/20 dark:bg-emerald-500/[0.02] flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="space-y-1">
        ...
        <div className="flex items-center justify-between gap-4 pt-6 border-t border-slate-200 dark:border-[#202020]">
          {prevTopic ? (
            <Link
              to={`/topics/${prevTopic.id}`}
              className="flex-1 flex items-center gap-3 p-4 rounded-xl border border-slate-200 dark:border-[#202020] bg-white dark:bg-[#0A0A0A] text-left hover:bg-slate-50 dark:hover:bg-[#151515] transition group"
            >
              ...
              <div>
                ...
                <span className="text-xs font-bold text-slate-700 dark:text-slate-300">{prevTopic.title}</span>
              </div>
            </Link>
          ) : (
          ...
          {nextTopic ? (
            <Link
              to={`/topics/${nextTopic.id}`}
              className="flex-1 flex items-center justify-end gap-3 p-4 rounded-xl border border-slate-200 dark:border-[#202020] bg-white dark:bg-[#0A0A0A] text-right hover:bg-slate-50 dark:hover:bg-[#151515] transition group"
            >
              <div>
                <span className="text-[10px] font-bold text-slate-500 uppercase block">Next Topic</span>
                <span className="text-xs font-bold text-slate-700 dark:text-slate-300">{nextTopic.title}</span>
              </div>
      ...
      <div className="space-y-6">
        ...
        {siblingTopics.length > 0 && (
          <div className="hidden lg:block p-5 rounded-xl border border-slate-200 dark:border-[#202020] bg-white dark:bg-[#0A0A0A] space-y-4 sticky top-4 z-10">
            <div className="space-y-1 border-b border-slate-200 dark:border-[#202020] pb-3">
              <div className="flex items-center justify-between" >
                ...
                <button
                  ...
                  className="p-1 rounded text-slate-400 hover:text-slate-200 transition hover:bg-slate-50 dark:hover:bg-[#151515]"
                >
                  <ChevronDown
                ...
                {siblingTopics.map((sibling, index) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between p-2 rounded-lg text-xs font-semibold transition ${
                        isCurrent
                          ? "bg-slate-100 dark:bg-[#1A1A1A] text-blue-600 dark:text-blue-400 border border-blue-500/20"
                          : isLocked
                          ? "opacity-40 cursor-not-allowed text-slate-500"
                          : "text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-[#151515] hover:text-slate-700 dark:hover:text-slate-200"
                      }`}
                    >
                      <div className="flex items-center gap-2 truncate">
                        {isCompletedSibling ? (
