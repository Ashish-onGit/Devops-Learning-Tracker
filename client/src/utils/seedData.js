export const seedData = {
  ...
  topicContents: [
    ...
    },
    {
      ...
      commonMistakes: [
        "Applying `chmod 777` to files just to resolve permission blocks.",
  ...
  tools: [
    ...
    },
    {
      ...
      useCases: ["Multi-cloud infrastructure provisioning", "Reproducible testing envs", "Resource drift detection"],
